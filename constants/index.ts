...
export const AdmissionsFaqItems = [
  {
    id: 1,
    question: "What are the eligibility criteria for admission?",
    description: "Applicants must have completed their higher secondary education (12th grade) or equivalent from a recognized board. Additional requirements may apply for specific programs.",
  },
  {
    id: 2,
    question: "What is the selection process?",
    description: "The selection process includes an online application, followed by a review of academic records and a personal interview. Shortlisted candidates will be notified via email.",
  },
  {
    id: 3,
    question: "Are scholarships available?",
    description: "Yes, we offer merit-based and need-based scholarships. Please refer to the Scholarships section for more details and application procedures.",
  },
  {
    id: 4,
    question: "How do I apply online?",
    description: "You can apply online by filling out the application form available on this page. Ensure all required documents are uploaded before submission.",
  },
  {
    id: 5,
    question: "Who can I contact for admissions support?",
    description: "For any queries, please email admissions@yourdomain.com or call our helpline at +91-12345-67890.",
  },
];