...
const FloatingElements = () => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    <div className="absolute top-20 left-10 w-96 h-96 bg-gradient-to-r from-blue-400/5 to-indigo-600/5 rounded-full blur-3xl animate-pulse"></div>
    <div className="absolute top-60 right-20 w-[28rem] h-[28rem] bg-gradient-to-r from-blue-500/5 to-indigo-700/5 rounded-full blur-3xl animate-pulse delay-1000"></div>
    <div className="absolute bottom-32 left-1/3 w-80 h-80 bg-gradient-to-r from-blue-300/5 to-indigo-600/5 rounded-full blur-3xl animate-pulse delay-2000"></div>
  </div>
);
...
export default function SaleXGallery() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-indigo-950 text-white relative overflow-hidden">
      ...
      <div className="relative">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-32 sm:px-6 lg:px-8">
          <div className="mb-8">
            <Link href="/gallery" className="inline-flex items-center gap-2 text-blue-300 hover:text-blue-100 transition-colors">
          ...
          <div className="text-center">
            <div className="inline-flex items-center gap-3 bg-gradient-to-r from-blue-500/10 to-blue-600/10 backdrop-blur-xl border border-blue-400/20 rounded-full px-8 py-3 mb-12 shadow-2xl">
              ...
              <span className="text-lg font-bold text-blue-200">Gallery Collection</span>
            </div>
            ...
            <p className="text-2xl md:text-3xl text-blue-100 max-w-5xl mx-auto leading-relaxed mb-16 font-light">
              Business development excellence and sales strategies
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pb-32">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-blue-100 max-w-4xl mx-auto font-light">
            Explore images from our sales training, business development initiatives, and client success stories
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {images.map((src, index) => (
            <motion.div
              ...
              className="relative group overflow-hidden bg-gradient-to-br from-blue-500/10 to-blue-600/5 backdrop-blur-xl border border-blue-400/20 rounded-2xl shadow-2xl h-80"
            >
        ...
        <div className="mt-24 text-center">
          <p className="text-xl text-blue-200 mb-6">
            Want to improve your business development strategies?
          </p>
          <Link href="/contact">
            <button className="px-8 py-4 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl text-white font-bold text-lg hover:shadow-lg hover:shadow-blue-500/30 transition-all duration-300 transform hover:scale-105">
              Contact Us
            </button>
          </Link>
        </div>
