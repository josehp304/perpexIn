  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 text-white py-4 text-center text-4xl font-bold tracking-tight md:text-7xl relative z-60"
        style={{
          color: "white"
        }}
      >
      ...
      >
        <div className="flex flex-col items-center">
          <p className="text-white mb-2 font-bold text-lg">Scroll Down</p>
          <svg 
            width="28" 
            height="28" 
            viewBox="0 0 24 24" 
